...
import io.github.lucciani.so.domain.exception.EntidadeNaoEncontradaException;
...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> handleAccessDeninedException(AccessDeniedException ex, WebRequest request) {
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
		...
		List<Problem.Object> problemFields = bindingResult.getFieldErrors().stream().map(objectError -> {
